...
# python3 -u train_nn_patch.py --epoch $EPOCH --data_base_path $SLURM_TMPDIR --crnn_model  $CRNN_MODEL_PATH --exp_base_path $EXP_BASE_PATH --exp_name patch_5_gvision_uniformCER --exp_id $EXP_NUM  --minibatch_subset rangeCER --minibatch_subset_prop 0.99  --inner_limit 1 --cers_ocr_path $CER_JSON_PATH --prep_model $PREP_MODEL_PATH --ocr gvision --report_test_perf --val_subset_size 50
