...
# PREP_MODEL_PATH="/home/ganesh/scratch/experiment_433/ckpts/Prep_model_2"
...
python3 -u train_nn_patch.py --epoch $EPOCH --data_base_path $SLURM_TMPDIR --crnn_model  $CRNN_MODEL_PATH --exp_base_path $EXP_BASE_PATH --exp_name unittest_patch_5_random_original2 --exp_id $EXP_NUM  --minibatch_subset random --minibatch_subset_prop 0.99  --inner_limit 1 --cers_ocr_path $CER_JSON_PATH --ocr Tesseract --val_subset_size 25   --train_subset_size 50 