...
python -u train_crnn.py --batch_size $BATCH_SIZE --epoch $EPOCH --crnn_model_path $CRNN_MODEL_PATH --dataset vgg --tb_logs_path $TB_LOGS_PATH --data_base_path $SLURM_TMPDIR --batch_size 64 --ocr EasyOCR
