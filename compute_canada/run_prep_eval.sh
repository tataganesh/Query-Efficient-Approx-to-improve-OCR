...
PREP_NAME="Prep_model_33_56.79"

echo "Evaluating EasyOCR $PREP_NAME on Tesseract"
python -u eval_prep.py --prep_path "$PREP_PATH/$PREP_NAME" --dataset $DATASET_NAME --data_base_path $SLURM_TMPDIR --ocr $OCR

# echo "Evaluating Tesseract $PREP_NAME on EasyOCR"
# python -u eval_prep.py --prep_path "$PREP_PATH/$PREP_NAME" --dataset $DATASET_NAME --data_base_path $SLURM_TMPDIR --ocr EasyOCR
