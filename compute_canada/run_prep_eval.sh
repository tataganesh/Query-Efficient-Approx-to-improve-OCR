...
do
    ...
    python -u eval_prep.py --prep_path "/home/ganesh/projects/def-nilanjan/ganesh/experiment_artifacts/experiment_$EXP_ID/ckpts/" --dataset vgg --prep_model_name "Prep_model_$i" --data_base_path $SLURM_TMPDIR
done